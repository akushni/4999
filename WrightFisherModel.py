...
numTrajectories = 10**5  # number of trajectories
...
#
# np.savetxt('trajectories',trajectories[250])
# np.savetxt('shuffledTrajs',newTrajs[250])
# np.savetxt('reversedTransform',reverseTransform[250])
# print(trajectories)
# print()
# print(newTrajs)
# print()
# print(FisherTrajs)
# print()
# print(newFisherTrajs)


#with open("trajectories",'w') as f: # for saving
    #np.savetxt(f, trajectories[500])
